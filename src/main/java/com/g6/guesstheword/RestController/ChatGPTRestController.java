...
public class ChatGPTRestController {
    ...
    public Map<String, Object> chooseWord(HttpSession session) {
        String Category = "League of legends character";
        ...
        messages.add(new Message("user", "make guess the word, using 5 emojis. Do not use unrelated emojis." +
                ...
                "the format is: wordchosen/emoji1-emoji2-emoji3-emoji4-emoji5. Follow the format, dont write anything else before or after, there has to be a dash between every emoji . try choosing less popular words. it must not be one of the following:"));
        ...
        session.setAttribute("usedWords", word);
